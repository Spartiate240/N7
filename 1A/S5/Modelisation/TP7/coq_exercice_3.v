...
intros E l;
induction l.
rewrite split_Nil. rewrite flatten_Nil.
reflexivity.
rewrite split_Cons. rewrite flatten_Cons. rewrite IHl. rewrite append_Cons.
rewrite append_Nil.
reflexivity.
Qed.
...
Nil _ => Nil _
( cons _ t q) => append_impl _ t (flatten(q))
end.
...
Proof.
intros E l; induction l; simpl.
rewrite flatten_Nil. reflexivity.
rewrite flatten_Cons. rewrite IHl. rewrite append_correctness. reflexivity.
Qed.
