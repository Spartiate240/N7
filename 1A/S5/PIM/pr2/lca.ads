...
package LCA is
	...
	procedure Afficher_Debug_LCA (Sda : in T_LCA);



			--pour Afficher_Debug de th
	function Get_Cle (Item : in T_LCA) return T_Cle;
	function Get_Valeur (Item : in T_LCA) return T_Valeur;
	function Get_Suivant (Item : in T_LCA) return T_LCA;
