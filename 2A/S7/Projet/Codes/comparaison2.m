...
TEB_RS_p = TEB_RS;
run('Viterbi_solomon_entrelace.m');
TEB_RS_e_p = TEB_RS_e;
...
semilogy(EbN0dB, TEB_RS_e_p, 'LineWidth', 2, 'Color', [0.80, 0.8, 0.1]); 
...
legend('TEB avec décodage soft', 'TEB avec décodage hard', 'TEB sans codage', ...
    'TEB avec décodage soft poinçonné', 'TEB avec décodage hard poinçonné','TEB avec Viterbi hard et Reed-solomon','TEB avec Viterbi hard et Reed-solomon entrelacé');
